...
app.config['MAIL_USERNAME'] = os.getenv('MAIL_USERNAME')  # tu correo Gmail
app.config['MAIL_PASSWORD'] = os.getenv('MAIL_PASSWORD')  # contraseña de aplicación (no la normal)
